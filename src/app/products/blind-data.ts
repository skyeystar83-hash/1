...
export const BLIND_PRODUCTS: Record<string, BlindProduct> = {
    "roll": {
        ...
        // ... (I will use simpler replace for robustness in tool call if possible, but replace_file_content needs exact match. I'll use multiple chunks or a large chunk for the subTypes)
        ...
        subTypes: [
            { name: "트렌솔", desc: "심플하고 모던한 디자인의 기본 롤스크린", image: "/images/roll-blinds/roll_trensoll.png" },
            { name: "카프리", desc: "고급스러운 텍스처와 은은한 광택감", image: "/images/roll-blinds/roll_capri.png" },
            { name: "라데나", desc: "자연스러운 직조감이 돋보이는 제품", image: "/images/roll-blinds/roll_radena.png" },
            { name: "퓨로룩스RR 1% 방염", desc: "강력한 자외선 차단과 방염 기능 (1%)", image: "/images/roll-blinds/roll_purolux_1_fr.jpg" },
            { name: "퓨로룩스RR 3% 방염", desc: "적절한 시야 확보와 차열 효과 (3%)", image: "/images/roll-blinds/roll_purolux_3_fr.jpg" },
            { name: "카멜레온 3% 방염", desc: "보는 각도에 따라 색감이 변하는 투톤 효과 (3%)", image: "/images/roll-blinds/roll_chameleon_3_fr.jpg" },
            { name: "카멜레온 1% 방염", desc: "고급스러운 펄감이 가미된 기능성 원단 (1%)", image: "/images/roll-blinds/roll_chameleon_1_fr.jpg" },
            { name: "썬스크린AT 3% 방염", desc: "효율적인 열 차단과 쾌적한 실내 환경 조성", image: "/images/roll-blinds/roll_sunscreen_at_3_fr.jpg" },
            { name: "썬스크린AT 1% 방염", desc: "눈부심 방지와 프라이버시 보호에 최적화", image: "/images/roll-blinds/roll_sunscreen_at_1_fr.jpg" },
            { name: "아카디아 암막", desc: "부드러운 컬러감의 고기능성 암막 스크린", image: "/images/roll-blinds/roll_arcadia_blackout.jpg" },
            { name: "메스티아", desc: "독특한 패턴과 질감으로 포인트가 되는 디자인", image: "/images/roll-blinds/roll_mestia.jpg" },
            { name: "솔트레이크 암막/방염", desc: "암막과 방염 기능을 동시에 갖춘 프리미엄 제품", image: "/images/roll-blinds/roll_saltlake_blackout_fr.jpg" },
            { name: "타히티", desc: "휴양지의 자연을 닮은 내추럴 텍스처", image: "/images/roll-blinds/roll_tahiti.jpg" },
            { name: "체로키 암막", desc: "차분하고 안정적인 분위기의 암막 롤스크린", image: "/images/roll-blinds/roll_cherokee_blackout.jpg" },
            { name: "마칼루 암막", desc: "깊이감 있는 컬러와 뛰어난 빛 차단력", image: "/images/roll-blinds/roll_makalu_blackout.jpg" },
            { name: "트레비", desc: "세련된 도시적 감성의 모던 스타일", image: "/images/roll-blinds/roll_trevi.jpg" },
            { name: "모레아", desc: "섬세한 패턴이 돋보이는 고급 원단", image: "/images/roll-blinds/roll_moray.jpg" },
            { name: "토리노 암막/방염", desc: "안전과 휴식을 위한 방염 암막 솔루션", image: "/images/roll-blinds/roll_torino_blackout_fr.jpg" },
            { name: "레인", desc: "비 내리는 듯한 감성적인 패턴", image: "/images/roll-blinds/roll_rain.jpg" },
            { name: "글리터", desc: "은은하게 반짝이는 펄이 매력적인 제품", image: "/images/roll-blinds/roll_glitter.jpg" },
            { name: "레놀라 암막/방염", desc: "고급 암막 원단에 방염 처리를 더한 안심 블라인드", image: "/images/roll-blinds/roll_lenola_blackout_fr.jpg" },
            { name: "레놀라 암막", desc: "완벽한 암막 효과로 수면 환경 개선", image: "/images/roll-blinds/roll_lenola_blackout.jpg" },
            { name: "엘바스", desc: "깔끔하고 단정한 느낌의 베이직 롤스크린", image: "/images/roll-blinds/roll_elbas.jpg" },
            { name: "체로키 암막/방염", desc: "체로키 암막의 고급스러움에 방염 기능 추가", image: "/images/roll-blinds/roll_cherokee_blackout_fr.jpg" },
            { name: "밀레 퍼펙트 암막/방염", desc: "최고 수준의 빛 차단율을 자랑하는 기능성 제품", image: "/images/roll-blinds/roll_millet_perfect_blackout_fr.jpg" },
            { name: "썬플렛 방염", desc: "화재 안전성을 높인 실용적인 방염 스크린", image: "/images/roll-blinds/roll_sunflat_fr.jpg" },
            { name: "로터스 암막", desc: "연꽃처럼 우아하고 부드러운 컬러감", image: "/images/roll-blinds/roll_lotus_blackout.jpg" },
            { name: "에코플렛", desc: "친환경 소재를 사용한 건강한 블라인드", image: "/images/roll-blinds/roll_ecoflat.jpg" },
            { name: "썬스크린 4TW 방염", desc: "트윌 조직으로 내구성이 뛰어난 썬스크린", image: "/images/roll-blinds/roll_sunscreen_tw_fr.jpg" },
            { name: "썬스크린 4DP 방염", desc: "독특한 조직감의 고기능성 방염 썬스크린", image: "/images/roll-blinds/roll_sunscreen_dp_fr.jpg" },
            { name: "솔티스99 방염", desc: "프랑스 서지페라리사의 명품 원단 (Soltis 99)", image: "/images/roll-blinds/roll_soltis99_fr.jpg" },
            { name: "솔티스99 방염-Alu", desc: "알루미늄 코팅으로 열 차단 효율 극대화", image: "/images/roll-blinds/roll_soltis99_alu_fr.jpg" },
            { name: "썬스크린 3N-1% 방염", desc: "촘촘한 1% 개방률로 프라이버시 보호 강화", image: "/images/roll-blinds/roll_sunscreen_3n1_fr.jpg" },
            { name: "썬스크린 3N-3% 메탈 방염", desc: "메탈릭한 마감으로 세련미와 기능성 겸비", image: "/images/roll-blinds/roll_sunscreen_3n3_metal_fr.jpg" },
            { name: "썬스크린 3N-3% 방염", desc: "표준적인 3% 개방률의 베스트셀러 썬스크린", image: "/images/roll-blinds/roll_sunscreen_3n3_fr.jpg" },
            { name: "누벨 암막/방염", desc: "부드러운 터치감의 고급 방염 암막", image: "/images/roll-blinds/roll_nouvelle_blackout_fr.jpg" },
            { name: "엑셀 암막/방염", desc: "합리적인 가격의 고기능성 암막/방염 제품", image: "/images/roll-blinds/roll_excel_blackout_fr.jpg" },
            { name: "에코스크린 방염", desc: "환경을 생각하는 친환경 방염 원단", image: "/images/roll-blinds/roll_ecoscreen_fr.jpg" },
            { name: "에코스크린 폼 암막/방염", desc: "폼 코팅으로 암막 효과를 높인 에코 스크린", image: "/images/roll-blinds/roll_ecoscreen_foam_blackout_fr.jpg" },
            { name: "파스텔 방염", desc: "화사한 파스텔 톤의 방염 롤스크린", image: "/images/roll-blinds/roll_pastel_fr.jpg" },
            { name: "마일드", desc: "은은하고 부드러운 컬러의 스테디셀러", image: "/images/roll-blinds/roll_mild.jpg" },
            { name: "비비드", desc: "생동감 넘치는 원색 컬러 포인트", image: "/images/roll-blinds/roll_vivid.jpg" },
            { name: "신디 방염", desc: "현대적인 감각의 패턴 방염 블라인드", image: "/images/roll-blinds/roll_cindy_fr.jpg" }
        ],
